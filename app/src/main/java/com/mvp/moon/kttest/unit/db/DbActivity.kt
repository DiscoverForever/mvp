...
import com.mvp.moon.kttest.R
import com.mvp.moon.kttest.base.BaseActivity
import com.mvp.moon.kttest.crud.GoodsDaoOpe
import com.mvp.moon.kttest.crud.UserDaoOpe
import com.mvp.moon.kttest.entity.goods.Goods
import com.mvp.moon.kttest.entity.user.User
import com.mvp.moon.kttest.event.LoginEvent
import com.mvp.moon.kttest.event.MessageEvent
import com.mvp.moon.kttest.unit.goods.GoodsActivity
import com.mvp.moon.kttest.utils.DialogUtils
...
class DbActivity() : BaseActivity(), DbContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        verticalLayout() {
            ...
            button("删除") {
                onClick {
                    AlertDialog.Builder(this@DbActivity).setTitle("test").setNegativeButton("取消", DialogInterface.OnClickListener { dialog, which ->
                        Log.d("1", "")
...
//                    lvUser.adapter = ArrayAdapter<String>(mContext, android.R.layout.simple_list_item_1, arrayListOf<String>("1", "2", "3"))
    ...
    fun getGoodsList(): ArrayList<Goods> {
        ...
        for (i in 11..20) {
            ...
            goods.picUrl = "https://image.mvp.cn/731945401be04d6e87cda4d08401785e.jpeg"
            goods.codeType = 2
